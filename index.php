...
<html>
 <head>
  <title>Super Admin Ajax PHP Mysql</title>
 ...
 <body>
  <br />
  <div class="container">
   <h3 align="center">Super Admin Ajax PHP Mysql</h3>
   <br />
   <div align="right">
 ...
 <div class="modal-dialog">
  <div class="modal-content">
   <form method="POST" id="edit_image_form">
	...
	<div class="form-group">
		<label>Author_Artist</label>
		<input type="text" name="Author_Artist" id="Author_Artist" class="form-control" />
	</div>
	<div class="form-group">
 ...
 $(document).on('click', '.edit', function(){
  ...
  $.ajax({
   ...
   success:function(data)
   {
	...
	$('#Author_Artist').val(data.Author_Artist);
